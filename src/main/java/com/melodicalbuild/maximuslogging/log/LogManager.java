...
public final class LogManager {
    ...
    /**
     * Should not be instantiated. Use {@link MaximusLogging#getLogManager()} instead.
     * @param pl the plugin instance
     * @param sender sender
     */
    public LogManager(@NotNull final MaximusLogging pl, @NotNull final CommandSender sender) {
        this.pl = pl;
    ...
    public void alertCommands(@NotNull final String pName, @NotNull final String command) {
        ...
        Bukkit.getOnlinePlayers().stream()
                .filter(p -> p.hasPermission("maximuslogging.getlogs") && !p.getName().equals(pName))
