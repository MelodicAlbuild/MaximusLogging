...
import com.melodicalbuild.maximuslogging.utils.Utils;
...
public final class LogUtils {
    ...
    /**
     * Should not be instantiated. Use {@link MaximusLogging#getLogUtils()} instead.
     * @param pl the plugin instance
     */
    public LogUtils(@NotNull final MaximusLogging pl) {
        this.pl = pl;
     ...
     * @param sender sender
     */
    void gzipOldLogs(@NotNull final CommandSender sender) {
     ...
     * @param sender sender
     */
    void deleteOldLogs(@NotNull final CommandSender sender) {
