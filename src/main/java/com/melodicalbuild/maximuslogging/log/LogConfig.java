...
public final class LogConfig {
    ...
    /**
     * Should not be instantiated. Use {@link com.melodicalbuild.maximuslogging.MaximusLogging#getLogConfig()} instead.
     * @param pl the plugin instance
     * @param sender the sender
     */
    public LogConfig(@NotNull final MaximusLogging pl, @NotNull final CommandSender sender) {
        // Is Citizens enabled?
